...
; PhaseFit benchmark: threshold 11, phase-1 anchor 3, phase-2 increment 1.
...
(rule (=> (and (= x1 0) (= y1 3) (= z1 3)) (inv x1 y1 z1)))

(rule
  (=>
    (and
      (inv x0 y0 z0)
      (= x1 (ite (< x0 11) (+ x0 1) x0))
      (= y1 (ite (< x0 11) 3 (+ y0 1)))
      (= z1 (ite (< x0 11) 3 (+ z0 1))))
    (inv x1 y1 z1)))
...
(rule
  (=>
    (and (inv x0 y0 z0) (>= x0 11) (not (= (f y0) (f z0))))
    fail))
