...
; PhaseFit benchmark: threshold 13, phase-1 anchor 7, phase-2 increment 1.
...
(rule (=> (and (= x1 0) (= y1 7) (= z1 7)) (inv x1 y1 z1)))

(rule
  (=>
    (and
      (inv x0 y0 z0)
      (= x1 (ite (< x0 13) (+ x0 1) x0))
      (= y1 (ite (< x0 13) 7 (+ y0 1)))
      (= z1 (ite (< x0 13) 7 (+ z0 1))))
    (inv x1 y1 z1)))
...
(rule
  (=>
    (and (inv x0 y0 z0) (>= x0 13) (not (= (f y0) (f z0))))
    fail))
